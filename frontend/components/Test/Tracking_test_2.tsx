...
const PreCalculatedTimeline2: React.FC = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Pre-calculated Timeline Safety System V2</Text>
      ...
      <View style={styles.instructionsContainer}>
        ...
        <Text style={styles.instruction}>• Emergency logic is now inside the notification handler</Text>
...
export default PreCalculatedTimeline2;
